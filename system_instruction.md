...
* **Paragraph Detection (CRITICAL):**
    ...
    * **Action (CRITICAL):** When you see this indentation, do **NOT** reproduce the indentation. Instead, **press "Enter" twice** to create a standard Markdown paragraph break.
...
**Page Structure:**
* **Start of Page:** Insert `*filename*` followed by an empty line (press Enter twice).
* **End of Page:** Insert `<div style="page-break-after: always;"></div>` followed by an empty line (press Enter twice) (except for the very last page).
...
Generate the transcription as markdown. Apply all formatting rules from the "Style & Formatting Guide" above. Do not include any other commentary.
